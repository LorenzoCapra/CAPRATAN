...
Nodes.S1.alfa               = 0.18; % [-]
Nodes.S1.emissivity         = 0.15; % [-]
Nodes.S1.conductivity       = 175; % [W/mK]
Nodes.S1.Pdiss              = 0; % [W]
Nodes.S1.F                  = 0.5; % [-]
Nodes.S1.T0                 = cent2Kelvin(30); % [K]
...
Nodes.S2.alfa               = 0.18; % [-]
Nodes.S2.emissivity         = 0.15; % [-]
Nodes.S2.conductivity       = 175; % [W/mK]
Nodes.S2.Pdiss              = 0; % [W]
Nodes.S2.F                  = 0.5; % [-]
Nodes.S2.T0                 = cent2Kelvin(30); % [K]
...
Nodes.S3.alfa               = 0.18; % [-]
Nodes.S3.emissivity         = 0.15; % [-]
Nodes.S3.conductivity       = 175; % [W/mK]
Nodes.S3.Pdiss              = 0; % [W]
Nodes.S3.F                  = 0.5; % [-]
Nodes.S3.T0                 = cent2Kelvin(30); % [K]
...
Nodes.S4.alfa               = 0.18; % [-]
Nodes.S4.emissivity         = 0.15; % [-]
Nodes.S4.conductivity       = 175; % [W/mK]
Nodes.S4.Pdiss              = 0; % [W]
Nodes.S4.F                  = 0.5; % [-]
Nodes.S4.T0                 = cent2Kelvin(30); % [K]
...
Nodes.S5.alfa               = 0.18; % [-]
Nodes.S5.emissivity         = 0.15; % [-]
Nodes.S5.conductivity       = 175; % [W/mK]
Nodes.S5.Pdiss              = 0; % [W]
Nodes.S5.F                  = 0.5; % [-]
Nodes.S5.T0                 = cent2Kelvin(30); % [K]
...
Nodes.S6.alfa               = 0.18; % [-]
Nodes.S6.emissivity         = 0.15; % [-]
Nodes.S6.conductivity       = 175; % [W/mK]
Nodes.S6.Pdiss              = 0; % [W]
Nodes.S6.F                  = 0.5; % [-]
Nodes.S6.T0                 = cent2Kelvin(30); % [K]
