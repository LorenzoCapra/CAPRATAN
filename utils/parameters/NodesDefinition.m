...
Nodes.S1.thickness          = 0.003; % [m]
Nodes.S1.V                  = Nodes.S1.A*Nodes.S1.thickness; % [m^3]
Nodes.S1.cv                 = 900; % [J/kgK]
Nodes.S1.alfa               = 0.4; % [-]
Nodes.S1.emissivity         = 0.21; % [-]
Nodes.S1.conductivity       = 175; % [W/mK]
Nodes.S1.Pdiss              = 0; % [W]
Nodes.S1.F                  = 0.5; % [-]
...
Nodes.S2.thickness          = 0.003; % [m]
Nodes.S2.V                  = Nodes.S2.A*Nodes.S2.thickness; % [m^3]
Nodes.S2.cv                 = 900; % [J/kgK]
Nodes.S2.alfa               = 0.4; % [-]
Nodes.S2.emissivity         = 0.21; % [-]
Nodes.S2.conductivity       = 175; % [W/mK]
Nodes.S2.Pdiss              = 0; % [W]
Nodes.S2.F                  = 0.5; % [-]
...
Nodes.S3.thickness          = 0.003; % [m]
Nodes.S3.V                  = Nodes.S3.A*Nodes.S3.thickness; % [m^3]
Nodes.S3.cv                 = 900; % [J/kgK]
Nodes.S3.alfa               = 0.4; % [-]
Nodes.S3.emissivity         = 0.21; % [-]
Nodes.S3.conductivity       = 175; % [W/mK]
Nodes.S3.Pdiss              = 0; % [W]
Nodes.S3.F                  = 0.5; % [-]
...
Nodes.S4.thickness          = 0.003; % [m]
Nodes.S4.V                  = Nodes.S4.A*Nodes.S4.thickness; % [m^3]
Nodes.S4.cv                 = 900; % [J/kgK]
Nodes.S4.alfa               = 0.4; % [-]
Nodes.S4.emissivity         = 0.21; % [-]
Nodes.S4.conductivity       = 175; % [W/mK]
Nodes.S4.Pdiss              = 0; % [W]
Nodes.S4.F                  = 0.5; % [-]
...
Nodes.S5.thickness          = 0.003; % [m]
Nodes.S5.V                  = Nodes.S5.A*Nodes.S5.thickness; % [m^3]
Nodes.S5.cv                 = 900; % [J/kgK]
Nodes.S5.alfa               = 0.4; % [-]
Nodes.S5.emissivity         = 0.21; % [-]
Nodes.S5.conductivity       = 175; % [W/mK]
Nodes.S5.Pdiss              = 0; % [W]
Nodes.S5.F                  = 0.5; % [-]
...
Nodes.S6.thickness          = 0.003; % [m]
Nodes.S6.V                  = Nodes.S6.A*Nodes.S6.thickness; % [m^3]
Nodes.S6.cv                 = 900; % [J/kgK]
Nodes.S6.alfa               = 0.4; % [-]
Nodes.S6.emissivity         = 0.21; % [-]
Nodes.S6.conductivity       = 175; % [W/mK]
Nodes.S6.Pdiss              = 0; % [W]
Nodes.S6.F                  = 0.5; % [-]
...
Nodes.SP1.rho               = 2200; % [km/m^3]
Nodes.SP1.thickness         = 0.003; % [m]
Nodes.SP1.V                 = Nodes.SP1.A*Nodes.SP1.thickness; % [m^3]
Nodes.SP1.cv                = 500; % [J/kgK]
Nodes.SP1.alfa              = 0.7; % [-]
Nodes.SP1.emissivity        = 0.5; % [-]
Nodes.SP1.conductivity      = 58; % [W/mK]
Nodes.SP1.Pdiss             = 20; % [W]
Nodes.SP1.F                 = 0.5; % [-]
...
Nodes.SP2.rho               = 2200; % [km/m^3]
Nodes.SP2.thickness         = 0.003; % [m]
Nodes.SP2.V                 = Nodes.SP2.A*Nodes.SP2.thickness; % [m^3]
Nodes.SP2.cv                = 500; % [J/kgK]
Nodes.SP2.alfa              = 0.7; % [-]
Nodes.SP2.emissivity        = 0.5; % [-]
Nodes.SP2.conductivity      = 58; % [W/mK]
Nodes.SP2.Pdiss             = 20; % [W]
Nodes.SP2.F                 = 0.5; % [-]
...
Nodes.SP3.rho               = 2200; % [km/m^3]
Nodes.SP3.thickness         = 0.003; % [m]
Nodes.SP3.V                 = Nodes.SP3.A*Nodes.SP3.thickness; % [m^3]
Nodes.SP3.cv                = 500; % [J/kgK]
Nodes.SP3.alfa              = 0.7; % [-]
Nodes.SP3.emissivity        = 0.5; % [-]
Nodes.SP3.conductivity      = 58; % [W/mK]
Nodes.SP3.Pdiss             = 20; % [W]
Nodes.SP3.F                 = 0.5; % [-]
...
Nodes.SP4.rho               = 2200; % [km/m^3]
Nodes.SP4.thickness         = 0.003; % [m]
Nodes.SP4.V                 = Nodes.SP4.A*Nodes.SP4.thickness; % [m^3]
Nodes.SP4.cv                = 500; % [J/kgK]
Nodes.SP4.alfa              = 0.7; % [-]
Nodes.SP4.emissivity        = 0.5; % [-]
Nodes.SP4.conductivity      = 58; % [W/mK]
Nodes.SP4.Pdiss             = 20; % [W]
Nodes.SP4.F                 = 0.5; % [-]
...
Nodes.Prop.alfa             = 0.18; % [-]
Nodes.Prop.emissivity       = 0.21; % [-]
Nodes.Prop.conductivity     = 200; % [W/mK]
Nodes.Prop.Pdiss            = 40; % [W]
Nodes.Prop.F                = 0.5; % [-]
...
% Nodes.Eps.rho               = 2200; % [km/m^3]
% Nodes.Eps.V                 = 0.005; % [m^3]
% Nodes.Eps.cv                = 1300; % [J/kgK]
% Nodes.Eps.alfa              = 0.34; % [-]
% Nodes.Eps.emissivity        = 0.55; % [-]
% Nodes.Eps.conductivity      = 25; % [W/mK]
...
Nodes.Eps.A                 = 0.01; % [m^2]
Nodes.Eps.rho               = 2200; % [km/m^3]
Nodes.Eps.V                 = 0.001; % [m^3]
Nodes.Eps.cv                = 1300; % [J/kgK]
Nodes.Eps.alfa              = 0.34; % [-]
Nodes.Eps.emissivity        = 0.55; % [-]
Nodes.Eps.conductivity      = 25; % [W/mK]
Nodes.Eps.Pdiss             = 30; % [W]
Nodes.Eps.F                 = 0.5; % [-]
Nodes.Eps.T0                = cent2Kelvin(20); % [K]
Nodes.Eps.thickness         = 0.05; % [m]
Nodes.Eps.Ac                = 0.01; % [m^2]
...
Nodes.Antenna.rho           = 1440; % [km/m^3]
Nodes.Antenna.V             = 0.001; % [m^3]
Nodes.Antenna.cv            = 1400; % [J/kgK]
Nodes.Antenna.alfa          = 0.7; % [-]
Nodes.Antenna.emissivity    = 0.7; % [-]
Nodes.Antenna.conductivity  = 120; % [W/mK]
Nodes.Antenna.Pdiss         = 10; % [W]
Nodes.Antenna.F             = 0.5; % [-]
Nodes.Antenna.T0            = cent2Kelvin(10); % [K]
Nodes.Antenna.thickness     = 0.01; % [m]
Nodes.Antenna.Ac            = 0.01; % [m^2]

%% Payload
Nodes.PL.A                  = 0.005; % [m^2]
Nodes.PL.rho                = 2700; % [km/m^3]
Nodes.PL.V                  = 0.002; % [m^3]
Nodes.PL.cv                 = 900; % [J/kgK]
Nodes.PL.alfa               = 0.4; % [-]
Nodes.PL.emissivity         = 0.21; % [-]
Nodes.PL.conductivity       = 25; % [W/mK]
Nodes.PL.Pdiss              = 6; % [W]
Nodes.PL.F                  = 0.5; % [-]
Nodes.PL.T0                 = cent2Kelvin(20); % [K]
Nodes.PL.thickness          = 0.01; % [m]
Nodes.PL.Ac                 = 0.001; % [m^2]
