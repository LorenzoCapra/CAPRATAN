...
Nodes.S1.conductivity       = 200; % [W/mK]
Nodes.S1.Pdiss              = 0; % [W]
Nodes.S1.F                  = 0.5; % [-]
...
Nodes.S2.conductivity       = 200; % [W/mK]
Nodes.S2.Pdiss              = 0; % [W]
Nodes.S2.F                  = 0.5; % [-]
...
Nodes.S3.conductivity       = 200; % [W/mK]
Nodes.S3.Pdiss              = 0; % [W]
Nodes.S3.F                  = 0.5; % [-]
...
Nodes.S4.conductivity       = 200; % [W/mK]
Nodes.S4.Pdiss              = 0; % [W]
Nodes.S4.F                  = 0.5; % [-]
...
Nodes.S5.conductivity       = 200; % [W/mK]
Nodes.S5.Pdiss              = 0; % [W]
Nodes.S5.F                  = 0.5; % [-]
...
Nodes.S6.conductivity       = 200; % [W/mK]
Nodes.S6.Pdiss              = 0; % [W]
Nodes.S6.F                  = 0.5; % [-]
...
Nodes.SP1.alfa              = 0.75; % [-]
Nodes.SP1.emissivity        = 0.84; % [-]
Nodes.SP1.conductivity      = 200; % [W/mK]
Nodes.SP1.Pdiss             = 0; % [W]
Nodes.SP1.F                 = 0.5; % [-]
...
Nodes.SP2.alfa              = 0.75; % [-]
Nodes.SP2.emissivity        = 0.84; % [-]
Nodes.SP2.conductivity      = 200; % [W/mK]
Nodes.SP2.Pdiss             = 0; % [W]
Nodes.SP2.F                 = 0.5; % [-]
...
Nodes.SP3.alfa              = 0.75; % [-]
Nodes.SP3.emissivity        = 0.84; % [-]
Nodes.SP3.conductivity      = 200; % [W/mK]
Nodes.SP3.Pdiss             = 0; % [W]
Nodes.SP3.F                 = 0.5; % [-]
...
Nodes.SP4.alfa              = 0.75; % [-]
Nodes.SP4.emissivity        = 0.84; % [-]
Nodes.SP4.conductivity      = 200; % [W/mK]
Nodes.SP4.Pdiss             = 0; % [W]
Nodes.SP4.F                 = 0.5; % [-]
...
Nodes.Antenna.alfa          = 0.5; % [-]
Nodes.Antenna.emissivity    = 0.7; % [-]
Nodes.Antenna.conductivity  = 200; % [W/mK]
