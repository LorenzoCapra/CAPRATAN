...
plot(time, Orbit.cth(:,3),'Color',color{3},LineWidth=1.5)
plot(time, Orbit.cth(:,4),'Color',color{4},LineWidth=1.5)
plot(time, Orbit.cth(:,5),'Color',color{5},LineWidth=1.5)
plot(time, Orbit.cth(:,6),'Color',color{6},LineWidth=1.5)
plot(time, Orbit.cth(:,7),'Color',color{7},LineWidth=1.5)
plot(time, Orbit.cth(:,8),'Color',color{8},LineWidth=1.5)
plot(time, Orbit.cth(:,9),'Color','g',LineWidth=1.5)
plot(time, Orbit.cth(:,10),'Color','y',LineWidth=1.5)
...
plot(time, Orbit.theta(:,3),'Color',color{3},LineWidth=1.5)
plot(time, Orbit.theta(:,4),'Color',color{4},LineWidth=1.5)
plot(time, Orbit.theta(:,5),'Color',color{5},LineWidth=1.5)
plot(time, Orbit.theta(:,6),'Color',color{6},LineWidth=1.5)
plot(time, Orbit.theta(:,7),'Color',color{7},LineWidth=1.5)
plot(time, Orbit.theta(:,8),'Color',color{8},LineWidth=1.5)
