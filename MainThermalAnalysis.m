...
ThermalState = [Nodes.S1.T0; Nodes.S2.T0; Nodes.S3.T0; Nodes.S4.T0; Nodes.S5.T0; Nodes.S5.T0; Nodes.Prop.T0; Nodes.Eps.T0; Nodes.Antenna.T0; Nodes.PL.T0];
...
while time < tspan(end)
    ...
    Thermal.Tprop(index) = T(end,7);
    Thermal.Teps(index)  = T(end,8);
    Thermal.Tant(index)  = T(end,9);
    Thermal.Tpl(index)   = T(end,10);
    ...
    ThermalState = [Thermal.Ts1(index), Thermal.Ts2(index), Thermal.Ts3(index), Thermal.Ts4(index), ...
                    Thermal.Ts5(index), Thermal.Ts6(index), Thermal.Tprop(index), ...
